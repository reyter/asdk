...
SOCKET CShortSocket::ConnectTo( CString strIpAddress,int c_nPort,CProxyOption * proxy )
{
	CStringA strIp(strIpAddress);
	return ConnectTo(strIp.GetBuffer(0), m_nPort,proxy);
}
